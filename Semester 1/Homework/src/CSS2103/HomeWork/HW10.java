...
public class HW10 {
    public static void main(String[] args) {
        ...
        double side1 = in.nextDouble(); //รับต่า side1
        System.out.print("Enter side 2 : "); //แสดงค่า Enter side 2 :
        double side2 = in.nextDouble(); //รับต่า side2
        ...
        String word = in.next(); //รับต่า number1
        vowel(word);
        System.out.println("");

        //ข้อ 4
        System.out.print("Enter hour : "); //แสดงค่า Enter hour :
        int hour = in.nextInt(); //รับต่า hour
        System.out.print("Enter minute : "); //แสดงค่า Enter minute :
        int minute = in.nextInt(); //รับต่า minute
